...
string tutorial_path = "/home/nimo/Downloads/real_time_pose_estimation_Opencv_Sample/"; // path to tutorial

string img_path = tutorial_path + "MyData/resized_IMG_3875.JPG";  // image to register
string ply_read_path = tutorial_path + "MyData/box.ply";          // object mesh
string write_path = tutorial_path + "MyData/cookies_ORB.yml";     // output file
...
int main()
{
    ...
    // load a mesh given the box.ply, about this bos mesh and size
    ...
    // Show the image
    imshow("MODEL REGISTRATION", img_vis);
    imwrite("/home/nimo/Pictures/0228/REGISTRATION.jpg", img_vis);
    ...
    // Show the image
    imshow("MODEL REGISTRATION", img_vis);
    imwrite("/home/nimo/Pictures/0228/REGISTRATION_2.jpg", img_vis);
